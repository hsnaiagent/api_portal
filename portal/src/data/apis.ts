...
export const initialApis: API[] = [
  ...
  api(
    ...
    'employee-directory',
    'Public employee directory and org chart data.',
    'public',
    'published',
    'user_developer',
    ['hr', 'directory'],
  ...
  api(
    'api_hr_salary',
    'dom_hr',
    'Employee Salary Statistics API',
    'salary-stats',
    'Aggregated salary statistics for HR reporting.',
    'confidential',
    'published',
    'user_developer',
    ['hr', 'payroll', 'salary'],
  ...
  api(
    ...
    'benefits',
    'Employee benefits enrollment status.',
    'confidential',
    'published',
    'user_developer',
    ['hr', 'benefits'],
  ...
  api(
    'api_hr_pii',
    'dom_hr',
    'Employee PII Vault API',
    'pii-vault',
    'Restricted personal identity data access.',
    'restricted',
    'published',
    'user_developer',
    ['hr', 'pii'],
  ...
  api(
    ...
    'recruitment',
    'Open positions and candidate pipeline.',
    'internal',
    'proposed',
    'user_developer',
    ['hr', 'recruitment'],
  ...
  api(
    ...
    'Budget Forecast API',
    'budget-forecast',
    'Budget vs actual forecast data.',
    'confidential',
    'published',
    'user_murad',
    ['finance', 'budget'],
  ...
  api(
    ...
    'invoices',
    'Vendor invoice status and payments.',
    'internal',
    'published',
    'user_murad',
    ['finance', 'invoices'],
  ...
  api(
    ...
    'quarterly-reports',
    'Quarterly financial report extracts.',
    'confidential',
    'under_review',
    'user_murad',
    ['finance', 'reports'],
  ...
  api(
    ...
    'assets',
    'Plant asset registry and maintenance.',
    'internal',
    'published',
    'user_murad',
    ['operations', 'assets'],
  ...
  api(
    ...
    'production',
    'Daily production output metrics.',
    'internal',
    'published',
    'user_murad',
  ...
  api(
    ...
    'safety',
    'Safety incident reporting data.',
    'confidential',
    'published',
    'user_murad',
    ['operations', 'safety'],
  ...
  api(
    ...
    'CRM Customer API',
    'crm-customers',
    'Customer master and contact data.',
    'internal',
    'published',
    'user_ali',
    ['sales', 'crm'],
  ...
  api(
    ...
    'Sales Forecast API',
    'sales-forecast',
    'Sales forecasting models output.',
    'confidential',
    'deprecated',
    'user_ali',
    ['sales', 'forecast'],
  ...
  api(
    'api_ai_llm',
    'dom_ai',
    'Enterprise LLM Completion API',
    'llm-completion',
    'Internal GPT-class model completions.',
    'internal',
    'published',
    'user_llm_admin',
    ['ai', 'llm', 'model'],
  ...
  api(
    ...
    'RAG Query API',
    'rag-query',
    'Retrieval-augmented generation over enterprise corpus.',
    'confidential',
    'published',
    'user_llm_admin',
    ['ai', 'rag'],
  ...
  api(
    ...
    'doc-classify',
    'Auto-classify documents by sensitivity.',
    'confidential',
    'in_testing',
    'user_llm_admin',
    ['ai', 'classification'],
