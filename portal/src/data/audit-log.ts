...
export const initialAuditLogs: AuditLog[] = [
  ...
  { audit_id: 'aud_010', timestamp: daysAgo(9), actor_user_id: 'user_developer', actor_type: 'user', action: 'api.registered', entity_type: 'api', entity_id: 'api_fin_budget', payload: {} },
