...
export type PortalAction =
  ...
  | {
      ...
      payload: { subscription_id: string; patch: Partial<Subscription> };
    }
  ...
  | {
      ...
      payload: { workflow_instance_id: string; patch: Partial<WorkflowInstance> };
    }
  ...
  | {
      ...
      payload: { request_id: string; patch: Partial<ProviderAccessRequest> };
    }
  ...
  | {
      ...
      payload: { llm_request_id: string; patch: Partial<LLMSubscriptionRequest> };
    }
