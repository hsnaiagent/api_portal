...
export function portalReducer(state: PortalState, action: PortalAction): PortalState {
  ...
  switch (action.type) {
    ...
    case 'UPDATE_SUBSCRIPTION':
      ...
      return {
        ...
        subscriptions: state.subscriptions.map((s) =>
          ...
          s.subscription_id === action.payload.subscription_id ? { ...s, ...action.payload.patch } : s,
    ...
    case 'UPDATE_APPLICATION':
      ...
      return {
        ...
        applications: state.applications.map((a) =>
          ...
          a.application_id === action.payload.application_id ? { ...a, ...action.payload.patch } : a,
    ...
    case 'UPDATE_WORKFLOW':
      ...
      return {
        ...
        workflows: state.workflows.map((w) =>
          ...
          w.workflow_instance_id === action.payload.workflow_instance_id ? { ...w, ...action.payload.patch } : w,
    ...
    case 'ADD_PROVIDER_REQUEST':
      ...
      return { ...state, providerAccessRequests: [...state.providerAccessRequests, action.payload] };
    ...
    case 'ADD_LLM_REQUEST':
      ...
      return { ...state, llmSubscriptionRequests: [...state.llmSubscriptionRequests, action.payload] };
    ...
    case 'UPDATE_LLM_REQUEST':
      ...
      return {
        ...
        llmSubscriptionRequests: state.llmSubscriptionRequests.map((r) =>
          ...
          r.llm_request_id === action.payload.llm_request_id ? { ...r, ...action.payload.patch } : r,
    ...
    case 'SET_PLANNER':
      ...
      return { ...state, plannerDescription: action.payload.description, plannerSelectedApiIds: action.payload.selected ?? state.plannerSelectedApiIds };
