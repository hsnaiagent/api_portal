...
function languageRequirements(language) {
  switch (language) {
    case 'curl':
...
export function buildSingleLanguageSdkPrompt(spec, language, apiName) {
...
export function buildPrecomputeSdkPrompt(spec, apiName) {
